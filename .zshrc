...
alias pstation='caffeinate -dis ssh -t -l pkryger -p 222 192.168.1.67 env PATH=/sbin:/bin:/usr/sbin:/usr/bin:/usr/syno/sbin:/usr/syno/bin:/usr/local/sbin:/usr/local/bin TERM=xterm-256color SHELL=/usr/local/bin/zsh /usr/local/bin/zsh -l'
